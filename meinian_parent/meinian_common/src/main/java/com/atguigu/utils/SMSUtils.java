...
public class SMSUtils {
    ...
    public static void sendShortMessage(String phoneNumbers,String param) throws Exception{
        ...
        // 替换成你的AK
        final String accessKeyId = "LTAI4GGAx4McMdcTxT38onN9";// 你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "z2kL9pfxmOtSCoh6D12Ni2abuhONJi";// 你的accessKeySecret，参考本文档步骤2
        ...
        // 必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_205121681");
